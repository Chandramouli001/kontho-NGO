    ...
    return (
        <>
                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+91-7385223242"><p>+91 7479134353 / 9330985565</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:sanjivani.vitswd@vit.edu"><p>kontho2019@gmail.com</p></a>
                                </div>
                            </div>
                        </div>
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">KONTHO-কণ্ঠ</Link>
